...
int main(int argc, const char** argv) {
    ...
    po.addOption("translation-tolerance",10, "maximum allowable translation error in metric units > 0");
    po.addOption("rotation-tolerance",15, "maximum allowable geodesic rotation error in degrees ]0, 180]");
      ...
      #pragma omp critical
          ...
          for(size_t i = 0; i < targets.size(); ++i) {
              ...
              for(size_t j = 0; j < queries.size(); ++j) {
                  ...
                  std::cout << "pscn: " << pscn << std::endl;
                  std::cout << "poseDir: " << poseDir << std::endl;
               ...
               //   const std::string poseFile = poseDir + "/" +  pscn + "." + poseSuffix;
                  std::cout << "poseFile: " << poseFile << std::endl;
