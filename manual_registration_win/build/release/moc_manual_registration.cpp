...
#include "../../src/manual_registration.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ManualRegistration_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 107, 11)
    ...
    "ManualRegistration\0calculatePressed\0"
    "\0clearPressed\0applyTrfmPressed\0"
    "on_btnModel_clicked\0on_btnScene_clicked\0"
    "timeoutSlot"
};
...
void ManualRegistration::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->calculatePressed(); break;
        case 1: _t->clearPressed(); break;
        case 2: _t->applyTrfmPressed(); break;
        case 3: _t->on_btnModel_clicked(); break;
        case 4: _t->on_btnScene_clicked(); break;
...
const QMetaObject ManualRegistration::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ManualRegistration.data,
      qt_meta_data_ManualRegistration,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ManualRegistration.stringdata))
