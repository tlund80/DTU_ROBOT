            ...
            */
             ...
             inline bool align(Eigen::Matrix4f &final_transformation)
             {
               ...
               //  if(_surfaceModel.Length() < 1)
                 ...
                 pcl::console::print_highlight("Detecting 3D model with Halcon!\n");
                 _num_matches = detector.detectModel(_scene_data);
                 if(_num_matches > 0){
                     pcl::console::print_highlight("Found ");
                     pcl::console::print_value("%d", _num_matches);
		      ...
		      pcl::console::print_error("No models detected with Halcon!\n");
                  return false;
                 }
